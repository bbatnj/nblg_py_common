...
from common.quants.stats import cohens_d
def calculate_cohens_d(df_res, df_vol, time_window_start_hours=-2, time_window_end_hours=4, freq='15T', percentiles=[50, 90], save_dir=None):
...
if __name__ == '__main__':
    ...
    result = calculate_cohens_d(df_res, df_vol)
    result.to_csv('cohen_d_results.csv', index=False)